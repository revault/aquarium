...
COORDINATORD_VERSION = os.getenv("COORDINATORD_VERSION", "0.4.0")
COSIGNERD_VERSION = os.getenv("COSIGNERD_VERSION", "0.4")
MIRADORD_VERSION = os.getenv("MIRADORD_VERSION", "0.0.2")
REVAULTD_VERSION = os.getenv("REVAULTD_VERSION", "0.4.0")
REVAULT_GUI_VERSION = os.getenv("REVAULT_GUI_VERSION", "0.4")
